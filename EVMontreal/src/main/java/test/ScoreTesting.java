...
public class ScoreTesting {
	public static void main(String[] args) throws IOException {
		Population pop = PopulationUtils.readPopulation("C:\\Users\\arsha\\git\\EVMontreal_newVersion\\EVMontreal\\1P\\population_with_locations_linkId.xml.gz");
		Config config = ConfigUtils.createConfig();
		config.households().setInputFile("C:\\Users\\arsha\\git\\EVMontreal_newVersion\\EVMontreal\\1P\\households.xml.gz");
...
//		fw.close();
		...
		scaleDownPopulation(pop,hh,0.01);
		new PopulationWriter(pop).write("C:\\Users\\arsha\\git\\EVMontreal_newVersion\\EVMontreal\\1P\\population_with_locations1P.xml.gz");
		new HouseholdsWriterV10(hh).writeFile("C:\\Users\\arsha\\git\\EVMontreal_newVersion\\EVMontreal\\1P\\households1P.xml.gz");
	}
