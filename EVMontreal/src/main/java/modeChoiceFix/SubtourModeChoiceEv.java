 ...
 *
 */
public class SubtourModeChoiceEv extends AbstractMultithreadedModule {

	private final double probaForChangeSingleTripMode;
	public static final String name = "subtour mode choice ev";
	...
	public SubtourModeChoiceEv(GlobalConfigGroup globalConfigGroup,
	...
	public PlanAlgorithm getPlanAlgoInstance() {
		...
		final ChooseRandomLegModeForSubtourEv chooseRandomLegMode =
				new ChooseRandomLegModeForSubtourEv(
