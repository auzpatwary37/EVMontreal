 ...
 */
public final class ChooseRandomLegModeForSubtourEv implements PlanAlgorithm {

	private static final  Logger logger = Logger.getLogger(ChooseRandomLegModeForSubtourEv.class);
	...
	public ChooseRandomLegModeForSubtourEv(
	...
	public void run(final Plan plan) {
		...
		choiceSet = choiceSet.stream().filter(c->doesNotHavePluginOrPlugOut(c.subtour)).collect(Collectors.toList());
